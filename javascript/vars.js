...
var jobs = ['A local coffee shop looks for coffee beans with emphasis on organic, fair-traded product (wt=50), followed by reliable delivery (wt=35) and service (wt=10). Price is not much a concern as customers often label organic to be more expensive.','A carmaker sources chips with emphasis on reliable delivery (wt=50). Chips are cheap (wt=10) and spec. is quite standard, so the service (wt=25) is more important than quality (wt=15).','A manufacturer in the consumer package goods (CPGs) industry is sourcing food-grade resins for containers of its food and beverage products. Food grade products have specific requirements, thus limit the possibilities of finding substitute components. Given this, quality (wt=50) is the most important. Reliable delivery with consistent supply is second to quality (wt=35) because resins are a byproduct of petroleum refining processes, anything that causes a decline in refining activity (such as storms, etc.) can set off a domino effect to resin production. Resins are widely used in various industries but are often sold with limited post-sales service (wt=5).','A carmaker sources the battery unit for its new electronic vehicles (EV). Battery is one key component for an EV, so the quality (wt=25) must be at least on par. What is the most important is post-sales service (wt=50).  Reliable delivery is slightly second to quality (wt=20).','The centralized purchasing department for chained coffee shops looks for coffee beans with emphasis on volume so that all its chained stores can have the same standard (wt=45) and reliable delivery (wt=35). Price is not a huge concern (wt=10) but quantity discount is expected since our volume is huge.  ','The local government is sourcing for the PPE (masks, face shield, etc.).  As the unit price is not high (wt=5), while the government purchasing takes tons of paperwork, it would be desirable to purchase a lot of them in one shot while the supplier can deliver in batches or deliver whenever we (i.e., the government) request (wt=65). Of course, PPE should meet the FDA requirements and etc. (wt=25).','The centralized general service department of a bank with national presence is sourcing for the hand sanitizers for its branches across the entire country in response to the Covid-19 pandemic. The bank does not really concern about the ingredients (flavor or not, natural or synthetic, and etc.) but providing them shows the bank cares about its customers so the brand also does not matter (wt=5).  What is important is the supplier can deliver in batches or deliver whenever we (i.e., the bank) request (wt=70) to the required branch office. Since it can be anticipated that the need of hand sanitizers will continue, it would be great to have quantity discount and the price is guaranteed (wt=15). Other service seems to be limited since the product is quite standard but it is desirable to have the flexibility to bottle them in different sizes (in oz.) as some branch offices are bigger than others.'];
var jobs_used = [];
var quals = [['Quantity discount is typically not available but we are flexible in shipping, so if needed, we can ship in one unit or whatever unit customers request.','Quantity discount is not available. However, we do offer volume discount, which is calculated based on the weight (in tonnes).','Quantity discount is not available but we ship in batch, which save you logistics costs.','We do offer quantity discount but there is no fixed price/discount and everything is all up to the negotiations.','We do not offer quantity discount. However, we have three different shipping methods for customers to choose from.  The shipping rates are primarily contingent on the speed.'],['Here is what we offer: our quality rating is 86.2, on-time delivery rating 87.9, price rating 100, and the service rating 89.7. ','Here is what we offer: our quality rating is 88.2, on-time delivery rating 93.7, price rating is 90, and the service rating 88.7.','Here is what we offer: our quality rating is 94.2,  on-time delivery rating 89.7, price rating 82.5, and the service rating 85.7.','Here is what we offer: our quality rating is 89.2, on-time delivery rating 86.8, price rating 85.5, and the service rating 98.2.','Here is what we offer: our quality rating is 92.4, on-time delivery rating 89.8, price rating 80.5, and the service rating 90.3.','Here is what we offer: our quality rating is 85.5,  on-time delivery rating 96.7, price rating 81.3, and the service rating 84.7.','Here is what we offer: our quality rating is 84.5, on-time delivery rating 97.0, price rating 83.9, and the service rating 80.8.'],['We are interested in building long term relationships with our customers so that we can grow together!','We are not interested in building exclusive relationships with customers because an exclusive relationship means we have to give up other customers.','We are open to any kind of business--long term or contractual basis, you name it!','We are interested in expanding our customer base and would be happy to go along if the customer wants a long-term and even evergreen contract.'],['We have distribution centers on the east and west coasts. Our main production facilities are in Mexico so that we can keep the cost manageable. We do have an expansion plan to build another facility in the Midwest in these couple of years.', 'We have facilities around the world, so we can effectively spread the risk, particularly risks associated with natural cause (weather, earthquake, etc.)','We are in support of local businesses, and we are proud to thrive with the local communities!','We have facilities in 5 different states in USA, so wherever you are, we will be able to support you from our nearest facility.']];
var quals_used = [[],[],[],[]];
